...
const canWeDeliver = zipCode => {
    ...
    return console.log(`Sorry we cant deliver to your address`)
}
...
//     deliveryAreaZipCodes.includes(zipCode) ? console.log(`youre in the zone`): console.log(`youre oustide the delivery zone`)
// }
...
// canWeDeliverTwo(85980)
canWeDeliverThree(85204)
canWeDeliverThree(85909)
//////////////////PROBLEM 3////////////////////
/* 
